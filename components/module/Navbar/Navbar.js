                ...
                <div className={style.navbar_wrapper}>
                    <div className={style.navbar_right}>
                        ...
                        <ul className={style.navbar_menu_items}>
                            ...
                            <li className={style.navbar_item}>
                                <Link href='/Shop' className={`${style.navbar_item_link} ${menuActive === '/Shop' ? `${style.navbar_item_linkActive}` : ``}`}>
                                    فروشگاه
                                </Link>
                            </li>
                            <li className={style.navbar_item}>
                ...
                <div className={style.navbarRes_right}>
                    ...
                    <div className={style.navbarRes_right_menu} style={{display: isShowMenu ? "block" : "none"}}>
                        <ul className={style.navbarRes_menu_items}>
                            ...
                            <li className={style.navbarRes_menu_item}>
                                <Link href='/Shop' className={`${style.navbarRes_menu_link} ${menuActive === '/Shop' ? `${style.navbarRes_menu_linkActive}` : ``}`}>
                                    فروشگاه
                                </Link>
                            </li>
                            <li className={style.navbarRes_menu_item}>
                            ...
                            <li className={style.navbarRes_menu_item}>
                                <Link href='/Login' className={`${style.navbarRes_menu_link} ${menuActive === '/Login' ? `${style.navbarRes_menu_linkActive}` : ``}`}>
                                        ورود
                                </Link>
                            </li>
                            <li className={style.navbarRes_menu_item}>
